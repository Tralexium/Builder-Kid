with (objWorld) {
///game checks
global.count ++ //ADDED: oscillation timer
...
if (global.gameStarted)
{
    ...
    {
        // ALEX MODIFIED (you could change the room check into a script filled with rooms that disable/use the restart key)
        if (scrButtonCheckPressed(global.restartButton) && room != rAlexMyStage)
        {
        ...
        {
            global.gameTimeMicro += delta_time;
            global.gameTime += global.gameTimeMicro div 1000000;
            global.gameTimeMicro = global.gameTimeMicro mod 1000000;
        }
    }
